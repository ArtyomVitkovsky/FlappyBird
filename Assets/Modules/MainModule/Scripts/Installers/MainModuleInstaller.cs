...
namespace Modules.MainModule.Scripts.Installers
{
    public class MainModuleInstaller : MonoInstaller
    {
        ...
        [Header("DIFFICULTY")]
        [SerializeField] private DifficultySetupsHolder difficultySetupsHolder;
        ...
        public void BindDifficultiesHolder()
        {
            var difficultySetupsHolderInstance = Container
                .InstantiatePrefabForComponent<DifficultySetupsHolder>(difficultySetupsHolder);
            
            Container
                .Bind<DifficultySetupsHolder>()
                .FromInstance(difficultySetupsHolderInstance)
                .AsSingle();
        }
    }
}